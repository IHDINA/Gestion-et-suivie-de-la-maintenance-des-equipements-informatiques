     <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="device_stocks.php"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Equipements / Stock</a>
                            </li>
                            <li class="">
                            <a href="dev_name.php"><i class="icon-chevron-right"></i><i class="icon-folder-open-alt"></i>Type Equipements</a>
                            </li> 
						    <li>
                            <a href="newdevice.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Affetcter&nbsp;<span class="label label-success">Nv</span>&nbsp;Equipement
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						<li class="">						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Gerer Utilisateures
							<div class="muted pull-right"><i class="caret"></i></div></a>						
					  ...
					  <!------/.* notification sidebar*------->
						...
						<li class="dropdown">
                         ...
                         <li class="">
                           ...
                           <li>
                           <a href="#myModal" data-toggle="modal" tabindex="1"><i class="icon-chevron-right"></i><i class="icon-search"></i>&nbsp;Emplacement d'Equipements
</a>
                           </li>
