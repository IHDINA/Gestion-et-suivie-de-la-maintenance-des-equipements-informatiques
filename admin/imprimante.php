        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
                     <div class="row-fluid">
					 <a href="add_Device.php" class="btn btn-info"  id="add" data-placement="right" title="Clicker pour ajouter equipement" ><i class="icon-plus-sign icon-large"></i> Ajouter Equipement</a>
                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> List Imprimante (s)</div>
							 <div class="muted pull-right">
								Nombre Imprimante (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">List Imprimante (s)
 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               OR dev_name = 'SOURIS' OR dev_name = 'Souris'OR dev_name = 'mse' OR dev_name = 'MOUSE' OR dev_name = '(Mouse)' 
			 ...
			 <?php	
			   ...
			   OR dev_name = 'Cpu' OR dev_name = 'Unite Central' OR dev_name = 'unite central' OR dev_name = 'cntral prcessing unit' OR dev_name = 'centrl procesing unit' OR dev_name = 'central processing nit'
...
<!-----------------------------------Content------------------------------------>
		...
		LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		where dev_name = 'Imprimante' OR dev_name = 'IMPRIMANTE'
			   OR dev_name = 'imprimante' OR dev_name = 'pwer suply' OR dev_name = 'poer Suply'
			   OR dev_name = 'powersupply' OR dev_name = 'power_supply' OR dev_name = 'power.supply' OR dev_name = 'pwer.spply'
			   OR dev_name = '(power supply)' OR dev_name = '(powersupply)' OR dev_name = '(power_supply)' OR dev_name = '(power-supply)'
			   OR dev_name = 'POWER SUPPLY'
		...
		<td><?php
			...
			<td class="empty" width="80"><a rel="tooltip"  title="Modifier Equipement" id="e<?php echo $id; ?>" href="device_edit.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"> Modifier</i> </a></td>
		</tr>
