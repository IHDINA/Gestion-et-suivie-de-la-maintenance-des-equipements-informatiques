                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Liste Cable Alimentation (s)</div>
							  <div class="muted pull-right">
								Nombrer Cable Alimentation (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Liste Cable Alimentation (s) 
...
<!-----------------------------------Content------------------------------------>
		...
		<td><?php
			...
			<td class="empty" width="80"><a rel="tooltip"  title="Modfier Equipement" id="e<?php echo $id; ?>" href="device_edit.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"> Modifier</i> </a></td>
		</tr>
