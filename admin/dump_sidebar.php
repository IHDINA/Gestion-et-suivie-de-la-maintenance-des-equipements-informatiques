	             ...
	             <div class="empty"><img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>"></div>
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li class="active">						
                            ...
                            <li class="">
                            <a href="device_stocks.php"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Equipement / Stocks</a>
                            </li>
                            <li class="">
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						<li>						
                            ...
                            <li class="">
                            <a href="respTech_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Responsables Techniques</a>
                            </li>
						    <li class="">
