        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
				 ...
				 where dev_status = 'Repare' OR dev_status = 'repare' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Liste Equipment Repare (s)</div>
                          <div class="muted pull-right">
								Nombre Equipement: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Liste Equipment Repare (s)
	...
	<div class="pull-left">
			...
			<?php	
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Repare' and dev_name = 'cpu'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
			 ...
			 <?php	
	           ...
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Repare' and dev_name = 'Ecran' OR dev_status = 'Repare' and dev_name = 'ECRAN'  
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
			...
			OR dev_status = 'Repare'    and dev_name = 'scanner'  
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="print_r.php" class="btn btn-info" id="print" data-placement="left" title="Click"><i class="icon-print icon-large"></i> Imprimer Liste</a> 	 
...
<?php
		$device_query = mysql_query("select * from stdevice,location_details,stlocation,device_name	,fonctionnaire		
            				...
            				AND stdevice.fonct_id=fonctionnaire.fonct_id
							 ...
							 AND dev_status = 'Repare'  ORDER BY location_details.ld_id DESC")or die(mysql_error());
