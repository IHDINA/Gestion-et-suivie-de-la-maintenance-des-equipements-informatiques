	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Modifier Equipement</div>
                            </div>
...
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Modifier Type Equipement $dev_name')")or die(mysql_error());	
?>
<script>
