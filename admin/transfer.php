				...
				<?php include('device_location_slidebar.php'); ?>
						...
						<div class="span9" id="content">
                          ...
                          <div class="empty">
                              ...
                              <strong>vous allez redireger a la direction que vous avez choisit</strong>
                            </div>
			               </div>
	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">From:&nbsp;<?php echo $location_row['stdev_location_name']; ?>  Transferer Equipement</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Clicker pour retourner" href="mydevice.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i>Retourne</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
											<label class="control-label" for="inputEmail">Equipemenet</label>
											<div class="controls">			
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Transferer A</label>
			                                <div class="controls">
										...
										<button id="move" data-placement="right" title="Clicker pour transferer equipement" name="transfer" type="submit" class="btn btn-warning"><i class="icon-move"></i>Transferer</button>
										</div>
										</div>
										<script type="text/javascript">
										$(document).ready(function(){
										...
										mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','transferer equipement  $dev_name a emplacement location id $stdev_id')")or die(mysql_error());			
										?>
										<script>
										window.location = "mydevice.php<?php echo '?stdev_id='.$stdev_id; ?>"; 
										$.jGrowl("Equipment a bien transfere", { header: 'Transferer Equipement ' });
										</script>
										<?php
										}
