	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left"><i class="icon-building"></i> Location:&nbsp;<?php echo $location_row['stdev_location_name']; ?> Modifier Status</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Clicker pour retourner" href="mypower_cord.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i>Retourne</a>
										</div>
