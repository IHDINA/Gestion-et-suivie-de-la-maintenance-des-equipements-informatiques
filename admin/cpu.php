    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
			   ...
			   OR dev_name = 'Cpu' OR dev_name = 'Unite Central' OR dev_name = 'unite central' OR dev_name = 'centrl procesing unit' OR dev_name = 'central processing nit'
                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Liste Unite Central(s) </div>
							 <div class="muted pull-right">
								Nombre CPU (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Liste Unite Central (s)
