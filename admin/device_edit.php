            ...
            <div class="row-fluid">
				<?php include('Device_sidebar.php'); ?>
						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
									<a href="add_Device.php" class="btn btn-info"  id="add" data-placement="right" title="Clicker pour ajouter un equipement" ><i class="icon-plus-sign icon-large"></i> Ajouter Equipement</a>
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Modifier Equipement</div>
										<div class="muted pull-right"><a id="return" data-placement="left" title="Clicker pour retourner" href="device_stocks.php"><i class="icon-arrow-left icon-large"></i> Retourne</a></div>
																<script type="text/javascript">
																$(document).ready(function(){
																	$('#return').tooltip('show');
																	$('#return').tooltip('hide');
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_brand']; ?>" name="dev_brand" id="inputPassword" placeholder="Marque d'Equipement" required>
											</div>
										</div>
										
										<div class="control-group">
											<label class="control-label" for="inputPassword">Num Serie</label>
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_serial']; ?>" name="dev_serial" id="inputPassword" placeholder="Serie d'Equipement" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_model']; ?>" name="dev_model" id="inputPassword" placeholder="Model Equipement" required>
											</div>
										</div>
										...
										<button id="update" data-placement="right" title="Clicker pour modifier" name="update" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i> Modifier</button>
										</div>
										</div>
										<script type="text/javascript">
										$(document).ready(function(){
									    ...
									    mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Modifier Info Equipement $dev_name')")or die(mysql_error());
										?>
										<script>										
