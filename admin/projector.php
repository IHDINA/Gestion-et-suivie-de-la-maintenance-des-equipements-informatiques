        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 where dev_name = 'projector' OR dev_name = 'Projector'
                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Liste Projecteur (s)</div>
							 <div class="muted pull-right">
								Nombre de Projecteur (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Liste Projecteur (s)
 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
               ...
               ?>
				<li class="">
				<a href="Mouse.php">Souris&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
