                 ...
                 ?> 
				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;Liste nouvelle Imprimante (s) </div>
							 <div class="muted pull-right">
								Nombre Imprimante (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Liste nouvelle Imprimante (s)
...
<!-----------------------------------Content------------------------------------>
		...
		OR NOT EXISTS 
	    (select * from location_details where stdevice.id = location_details.id)
		and dev_status = 'OU' and dev_name = 'power.supply'
		OR NOT EXISTS 
	    (select * from location_details where stdevice.id = location_details.id)
		and dev_status = 'New' and dev_name = 'pwer.spply'
		OR NOT EXISTS 
