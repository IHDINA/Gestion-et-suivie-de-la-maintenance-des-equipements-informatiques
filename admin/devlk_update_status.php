	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<a id="return" data-placement="left" title="Clicker pour Retourner" href="mykeyboard.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i> Retourne</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<button id="update" data-placement="right" title="Clicker pour le modifie" name="update" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i> Modifie</button>
										</div>
										</div>
										<script type="text/javascript">
										$(document).ready(function(){
