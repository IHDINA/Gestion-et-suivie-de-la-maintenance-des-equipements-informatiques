        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
			     ...
			     OR dev_status = 'Endommage' and dev_name = 'Projecteur' OR dev_status = 'damage' and dev_name = 'monitr' OR dev_status = 'damage' and dev_name = 'mnitor'
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i>Liste Projecteur Endommage (s)</div>
                          <div class="muted pull-right">
								Nombre Equiepement (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Liste Projecteur Endommage (s) 
...
<?php
		$device_query = mysql_query("select * from stdevice,location_details,stlocation,device_name	,fonctionnaire		
            				...
            				AND stdevice.fonct_id=fonctionnaire.fonct_id
							 ...
							 AND dev_status = 'Endommage' and dev_name='Projecteur' ORDER BY location_details.ld_id DESC")or die(mysql_error());
