                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp; List nouveau CPU (s)</div>
							 <div class="muted pull-right">
								Nombre nouveau CPU (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">List nouveau CPU (s)
			...
			<?php	
			 ...
			 <?php	
			   ...
			   where NOT EXISTS 
		         ...
		         OR NOT EXISTS 
	             (select * from location_details where stdevice.id = location_details.id)
		         and dev_status = 'NOUVEAU' and dev_name = 'mnitor'
		         OR NOT EXISTS 
	             (select * from location_details where stdevice.id = location_details.id)
