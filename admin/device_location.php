                     ...
                     <div class="row-fluid">					 					 
                        ...
                        <div class="block">
								<div class="navbar navbar-inner block-header">
								    <div class="muted pull-left"><i class="icon-reorder icon-building"></i>Liste Emplacement (s)</div>
									
						<div id="" class="muted pull-right">
								<?php 
								$my_location = mysql_query("select * from stlocation ")or die(mysql_error());
								$count_my_location = mysql_num_rows($my_location);?>
								Nombre Emplacment (s): <span class="badge badge-info"><?php echo $count_my_location; ?></span>
						</div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul	 id="da-thumbs" class="da-thumbs">
										...
										<?php } }else{ ?>										
									     <div class="alert alert-info"><i class="icon-info-sign"></i>Il y a pas des emplacements</div>
										<?php  } ?>
									</ul>
                                </div>
                            </div>
