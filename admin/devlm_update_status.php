	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left"><i class="icon-building"></i> Emplacement:&nbsp;<?php echo $location_row['stdev_location_name']; ?> Status</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Clicker pour Retourner" href="mymouse.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i>Retourne</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										$.jGrowl("Status a bien Modifie", { header: 'Modification Sattus' });
										</script>
										<?php
										}
