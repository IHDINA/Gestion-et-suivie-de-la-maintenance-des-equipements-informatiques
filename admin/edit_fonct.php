    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_fonct_form.php'); ?>		   			
				</div>
				<?php	
								...
								<form action="delete_fonct.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="120">
												<a rel="tooltip"  title="Modifier le fonctionnaire" id="e<?php echo $id; ?>" href="edit_fonct.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Modifier</i></a>
												</td>
