                    ...
                    <div class="col-lg-12">
                      <div class="alert alert-success alert-dismissable">
                         <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                          <img id="avatar1" class="img-responsive" src="<?php echo $row['adminthumbnails']; ?>"><strong> Bienvenue ! <?php echo $user_row['firstname']." ".$user_row['lastname'];  ?></strong>
                      </div>
                    </div>
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        ...
                                        <div>Equipement Endommage</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        ...
                                        <div>Equipement en Dechet</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        ...
                                        <div>Localisation Equipement</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
