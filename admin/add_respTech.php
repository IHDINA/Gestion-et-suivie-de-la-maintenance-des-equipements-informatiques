  ...
  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-plus-sign icon-large"> Ajouter un nouveau Responsable Technique</i></div>
                            </div>
...
$query = mysql_query("select * from resptech where username = '$username' and password = '$password' and firstname = '$firstname' and password = '$password' ")or die(mysql_error());
...
mysql_query("insert into resptech (username,password,firstname,lastname,respthumbnails,designation,bureau,email,telephone) values('$username','$password','$firstname','$lastname','images/NO-IMAGE-AVAILABLE.jpg','$designation','$bureau','$email','$telephone')")or die(mysql_error());

mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Ajouter Responsable Technique $firstname')")or die(mysql_error());
?>
<script>
window.location = "respTech_user.php";
$.jGrowl("Responsable Technique a bien ajoute", { header: 'Responsable Technique a ajoute' });
</script>
<?php
}
}
