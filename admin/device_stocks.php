 ...
 <br/>
	<div class="pull-left">
			 ...
			 <?php	
			   ...
			   OR dev_name = 'imprimante' OR dev_name = 'Imprimante' OR dev_name = 'IMPRIMANTE' OR dev_name = 'poer Suply'
			   ...
			   OR dev_name = 'ecran' OR dev_name = 'Video.Graphic.Accelerator' OR dev_name = 'Video-Graphic-Accelerator' OR dev_name = 'Video_Graphic_Accelerator'
...
<?php
		...
		$id = $row['id'];
		$dev_id = $row['dev_id'];
        $p=html_entity_decode(trim($row['dev_desc'])) ;
		?>
