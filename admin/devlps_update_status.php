	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left"><i class="icon-building"></i>Emplacement:&nbsp;<?php echo $location_row['stdev_location_name']; ?> Modifier Status</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Clicker pour retourner" href="myimprimante.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i> Retourne</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword"  placeholder="Status" >Status</label>
											<div class="controls">
											<select value="" name="dev_status" required>
													<option><?php echo $row['dev_status']; ?></option>
													<option>Utilise</option>
													<option>Endommage</option>
												</select>								
											</div>
										</div>
										...
										<button id="update" data-placement="right" title="Clicker pour le modifier" name="update" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i>Modifier</button>
										</div>
										</div>
										<script type="text/javascript">
										$(document).ready(function(){
										...
										mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Modifier Status  $dev_name a $dev_status')")or die(mysql_error());		
										?>
										<script>
										window.location = "mypower_supply.php<?php echo '?stdev_id='.$stdev_id; ?>"; 
										$.jGrowl("Status a bien Modifie", { header: 'Modification Status' });
										</script>
										<?php
										}
