            ...
            <div class="navbar-inner">
               <div class="container-fluid">
				 ...
				 <div class="navbar-header">
                    ...
                    <span class="brand" href="#">Panneau Administration</span>
				 </div>
				  <!--.nav-collapse -->
						...
						?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                       <a tabindex="-1" href="change_password_admin.php"><i class="icon-cog"></i>&nbsp;Changer Mot de Passe</a>
									   <a tabindex="-1" href="#myModal3" data-toggle="modal"><i class="icon-picture"></i>&nbsp;Changer Photo</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
