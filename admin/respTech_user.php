                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i>Liste Responsabales Techniques</div>
								...
								<form action="delete_respTech.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="120">
												<a rel="tooltip"  title="Modifier Utilisateurs" id="e<?php echo $id; ?>" href="edit_respTech.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large">Modifier </i></a>
												</td>
