     ...
     <body id="home">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_item=mysql_query("select *from stdevice,device_name where stdevice.dev_id=device_name.dev_id  and dev_name='Imprimante'
				 ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Liste des CPU</div>
							 <div class="muted pull-right">
								Nombre de CPU (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
...
<!-----------------------------------Content------------------------------------>
		...
		<?php
	    $device_query = mysql_query("select * from stdevice,device_name where stdevice.dev_id=device_name.dev_id and dev_name='Imprimante' and fonct_id='$session_id' 
