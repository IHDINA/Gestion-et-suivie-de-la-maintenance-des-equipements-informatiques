...
$obj = $_POST['option']; 
   ...
   if(!empty($message)){
        mysql_query("INSERT INTO messages VALUES('',$session_id ,'$idd','fonctionnaire','$message',CURRENT_TIME(),'no','no','no','$obj','$type')") or die(" ");
     ...
     <br><br<br><br>  
                        <label>A Mr/Mme:</label>
                          ...
                          <select  name="option" >
                           ...
                           <option>Demande Maintenance</option>
                            
                          </select>
                   
                      
                        <label>Votre message:</label>
                          <textarea id="ckeditor_full" name="message" required style="margin: 0px 0px 10px; width: 659px; height: 206px;"></textarea><br>
