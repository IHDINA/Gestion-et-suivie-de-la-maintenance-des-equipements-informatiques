        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 where dev_status = 'Endommage' and dev_name = 'Cable Alimentation' OR dev_status = 'Endommage' and dev_name = 'cable alimentation' OR dev_status = 'Endommage' and dev_name = 'Cable_Alimentation'
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Liste Cable Alimentation Endommage (s)</div>
                          <div class="muted pull-right">
								Nombre Equipement (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Liste Cable Alimentation Endommage (s)
 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
			   ...
			   OR dev_name = 'clavier'  and dev_status = 'Endommage' OR dev_name = 'kyboard'  and dev_status = 'damage' OR dev_name = 'kboard'  and dev_status = 'damage'
			...
			<?php	
			   ...
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where 
			      dev_status = 'Endommage'    and dev_name = 'Souris'       OR dev_status = 'Endommage'  and dev_name = 'souris'       OR dev_status = 'Endommage' and dev_name = 'SOURIS'
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Endommage' and dev_name = 'PROJECETUR' OR dev_status = 'damage' and dev_name = 'monitr' OR dev_status = 'damage' and dev_name = 'mnitor'
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Endommage' and dev_name = 'cpu' OR dev_status = 'Endommage' and dev_name = 'Unite Central' OR dev_status = 'Endommage' and dev_name = 'Unite_Central' OR dev_status = 'damage' and dev_name = 'c.p.u.'
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Endommage' and dev_name = 'imprimante' OR dev_status = 'damage' and dev_name = 'power spply' OR dev_status = 'damage' and dev_name = 'pwer suply'
	           ...
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Endommage' and dev_name = 'Ecran' OR dev_status = 'Endommage' and dev_name = 'ecran' OR dev_status = 'Endommage' and dev_name = 'ECRAN'
	           ...
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Endommage' and dev_name = 'Cable Alimetation' OR dev_status = 'Endommage' and dev_name = 'cable alimentation ' OR dev_status = 'Endommage' and dev_name = 'Cable_Alimetation'
			   OR dev_status = 'damage' and dev_name = '(power cord)' OR dev_status = 'damage' and dev_name = 'power.cord' OR dev_status = 'damage' and dev_name = '(pwer crd)' OR dev_status = 'damage' and dev_name = 'powr coRd'
			   OR dev_status = 'damage' and dev_name = 'ower cord' OR dev_status = 'damage' and dev_name = 'power cordss' OR dev_status = 'damage' and dev_name = 'pwer crd' OR dev_status = 'damage' and dev_name = 'POWER CORD'
			   OR dev_status = 'damage' and dev_name = 'poer cd' OR dev_status = 'damage' and dev_name = 'powe cor'OR dev_status = 'damage' and dev_name = 'powercord'OR dev_status = 'damage' and dev_name = 'power-cord'
			   ORDER BY stdevice.id DESC");
			...
			OR dev_status = 'Endommage'    and dev_name = 'SCANNERr'  OR dev_status = 'damage'     and dev_name = 'automatic Voltage Reactor' 
...
<?php
		$device_query = mysql_query("select * from stdevice			
			   ...
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Endommage' and dev_name = 'Cable Alimetation' OR dev_status = 'Endommage' and dev_name = 'cable alimentation' OR dev_status = 'Endommage' and dev_name = 'Cable_Alimentation'
			   OR dev_status = 'damage' and dev_name = '(power cord)' OR dev_status = 'damage' and dev_name = 'power.cord' OR dev_status = 'damage' and dev_name = '(pwer crd)' OR dev_status = 'damage' and dev_name = 'powr coRd'
			   OR dev_status = 'damage' and dev_name = 'ower cord' OR dev_status = 'damage' and dev_name = 'power cordss' OR dev_status = 'damage' and dev_name = 'pwer crd' OR dev_status = 'damage' and dev_name = 'POWER CORD'
			   OR dev_status = 'damage' and dev_name = 'poer cd' OR dev_status = 'damage' and dev_name = 'powe cor'OR dev_status = 'damage' and dev_name = 'powercord'OR dev_status = 'damage' and dev_name = 'power-cord'
