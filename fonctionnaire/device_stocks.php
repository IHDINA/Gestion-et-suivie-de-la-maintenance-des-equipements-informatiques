...
<?php include('session.php'); ?>
     <body id="home">
        ...
        <div class="container-fluid">
			...
			<?php	
	             $count_item=mysql_query("select * from stdevice,fonctionnaire where stdevice.fonct_id=fonctionnaire.fonct_id and fonctionnaire.fonct_id='$session_id'");
...
<!-----------------------------------Content------------------------------------>
<?php
		$device_query = mysql_query("select * from stdevice,device_name where stdevice.dev_id=device_name.dev_id and fonct_id='$session_id'")or die(mysql_error());
