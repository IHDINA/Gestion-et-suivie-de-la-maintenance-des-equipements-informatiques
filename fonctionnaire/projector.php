                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Liste des Projecteur</div>
...
<!-----------------------------------Content------------------------------------>
		...
		<?php
	    $device_query = mysql_query("select * from stdevice,device_name where stdevice.dev_id=device_name.dev_id and dev_name='Projecteur' and fonct_id='$session_id' 
