...
<!-----------------------------------Content------------------------------------>
		...
		<?php
	    $device_query = mysql_query("select * from stdevice,device_name where stdevice.dev_id=device_name.dev_id and dev_name='Cable Alimentation' and fonct_id='$session_id' 
