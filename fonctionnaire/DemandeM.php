...
if(isset($_POST['submit'])){
 ...
 while(  $donnees = mysql_fetch_array($sql)){
   ...
   if(!empty($message)){
        mysql_query("INSERT INTO messages VALUES('',$session_id ,'$i','fonctionnaire','$message',CURRENT_TIME(),'no','no','no','Demande Equipement','respAdm')") or die(" ");
         mysql_query("insert into notification (fullname,notification,date_of_notification,link) 
			value('$client_fullname','Envoyer un message , Sujet : Demande Maintenance' ,NOW(), 'inbox.php')")or die(mysql_error());
   }
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
					 ...
					 <?php	
	             $c=mysql_query( "select * from messages where SENDER='fonctionnaire' and ID_SENDER='$session_id' and objet='Demande Maintenance'");
     ...
     <br><br<br><br>  
                        <label>A Mr/Mme:</label>
                          ...
                          <select  name="name" required>
                            ...
                            $extract1 = mysql_query("SELECT * FROM resptech");
                          ...
                          <lable>Objet :<span style="color: gray;">Demande Maintenance</span></label>
                   <br><br>
