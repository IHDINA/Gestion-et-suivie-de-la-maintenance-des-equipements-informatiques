				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
							 ...
							 <div class="muted pull-right">
								Nombre de Souris (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
...
<!-----------------------------------Content------------------------------------>
		...
		<?php
	    $device_query = mysql_query("select * from stdevice,device_name where stdevice.dev_id=device_name.dev_id and dev_name='Souris' and fonct_id='$session_id' 
