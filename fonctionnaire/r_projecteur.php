        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
			     ...
			     OR dev_status = 'Repare' and dev_name = 'Projecteur' OR dev_status = 'damage' and dev_name = 'monitr' OR dev_status = 'damage' and dev_name = 'mnitor'
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i>Liste Projecteur Repare (s)</div>
                          <div class="muted pull-right">
								Nombre Equiepement (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Liste Projecteur Repare (s) 
