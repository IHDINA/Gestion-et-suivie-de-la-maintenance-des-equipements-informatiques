...
mysql_query("update stdevice set dev_status='Repare' where id = '$get_id'")or die(mysql_error());
mysql_query("insert into notification (fullname,notification,date_of_notification,link) 
			value('$client_fullname','Reparer $dev_name, Serial : $dev_serial' ,NOW(), 'device_stocks.php')")or die(mysql_error());					
