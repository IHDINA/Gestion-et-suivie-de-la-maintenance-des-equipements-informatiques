  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-check"></i><strong> Imprimer Liste Equipements en Dechet</strong>
            </div>
       </div>
    </div>
  </div>
...
"Times New Roman","serif"'> EQUIPEMENTS en Dechet:<o:p></o:p></span></p>
   ...
   <div class="empty">
       ...
       <script type="text/javascript">
         ...
         $('#print').tooltip('hide');
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
      <a id="return" data-placement="top" class="btn btn-success" title="Clicker pour retourner" href="device_stocks.php"><i class="icon-arrow-left"></i> Retourne</a></p>    
      <script type="text/javascript">
      $(document).ready(function(){
      $('#return').tooltip('show');
      $('#return').tooltip('hide');
...
<?php
    $device_query = mysql_query("select * from stdevice 
         ...
         where dev_status = 'Dechet' OR dev_status = 'Dechet' ORDER BY stdevice.id DESC ")or die(mysql_error());
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php  
         ...
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where dev_name = 'Clavier' and dev_status = 'Dechet' OR dev_name = 'clavier'  and dev_status = 'Dechet'
         OR dev_name = 'CLAVIER'  and dev_status = 'Dechet' 
...
?>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
  "Times New Roman","serif"'>Dechet<o:p></o:p></span></p>
  </td>
 ...
 <?php  
         ...
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where 
            dev_status = 'Dechet'    and dev_name = 'SOURIS'       OR dev_status = 'souris'  and dev_name = 'Dechet'       OR dev_status = 'Dechet' and dev_name = 'Souris'
...
<?php 
             $count_item=mysql_query("select * from stdevice 
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where dev_status = 'Dechet' and dev_name = 'projecteur' OR dev_status = 'Dechet' and dev_name = 'Projecteur'
         OR dev_status = 'Dechet' and dev_name = 'PROJECTEUR' 
         ORDER BY stdevice.id DESC");
             $count = mysql_num_rows($count_item);
?>
...
<?php 
             $count_item=mysql_query("select * from stdevice 
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where dev_status = 'Dechet' and dev_name = 'CPU' OR dev_status = 'Dechet' and dev_name = 'Cpu'
         OR dev_status = 'Dechet' and dev_name = 'cpu' OR dev_status = 'Dechet' and dev_name = 'Unite Central' 
         ORDER BY stdevice.id DESC");
             $count = mysql_num_rows($count_item);
?>
 <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
 ...
 <?php  
             $count_item=mysql_query("select * from stdevice 
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where dev_status = 'Dechet' and dev_name = 'Imprimante' OR dev_status = 'Dechet' and dev_name = 'IMPRIMANTE' 
         OR dev_status = 'Dechet' and dev_name = 'imprimante' 
         ORDER BY stdevice.id DESC");
             $count = mysql_num_rows($count_item);
?>
 <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes'>
...
<?php 
             $count_item=mysql_query("select * from stdevice 
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where dev_status = 'Dechet' and dev_name = 'Ecran' OR dev_status = 'Dechet' and dev_name = 'ECRAN' OR dev_status = 'Dechet' and dev_name = 'Dechet'
 ...
 <?php  
             $count_item=mysql_query("select * from stdevice 
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where dev_status = 'Dechet' and dev_name = 'Cable Alimentation' OR dev_status = 'Dechet' and dev_name = 'Cable_Alimentation' OR dev_status = 'Dechet' and dev_name = 'cable alimentation'
...
?>  
 ...
 <?php  
         ...
         LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
         where 
         dev_status = 'Dechet'    and dev_name = 'Scanner'                          OR dev_status = 'Dechet'     and dev_name = 'SCANNER' 
