...
<?php include('session.php'); ?>
    <body id="home">
        ...
        <div class="container-fluid">
			...
			OR dev_status = 'Repare'    and dev_name = 'scanner'  OR dev_status = 'damage'     and dev_name = 'automatic Voltage Reactor' 
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i>Liste Scanner Repare (s)</div>
                          <div class="muted pull-right">
								Nombre Equipement: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Liste Scanner Repare (s)
...
<?php
		$device_query = mysql_query("select * from stdevice			
			   ...
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where 
			   dev_status = 'Repare'    and dev_name = 'Scanner'                          OR dev_status = 'Emdommage'     and dev_name = 'scanner' 
			OR dev_status = 'Repare'    and dev_name = 'SCANNER'  OR dev_status = 'damage'     and dev_name = 'automatic Voltage Reactor' 
		    OR dev_status = 'damage'    and dev_name = 'automatic_Voltage_Regulator'  OR dev_status = 'damage'     and dev_name = 'automatic-Voltage-Regulator' 
			OR dev_status = 'damage'    and dev_name = 'avrs'                         OR dev_status = 'damage'     and dev_name = 'automatic v.r' 
			OR dev_status = 'damage'    and dev_name = 'automatic voltage R.'         OR dev_status = 'damage'     and dev_name = 'avregulator' 
