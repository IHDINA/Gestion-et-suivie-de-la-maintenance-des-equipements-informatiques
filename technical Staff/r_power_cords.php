	...
	<div class="pull-left">
			...
			<?php	
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Repare' and dev_name = 'cpu' OR dev_status = 'Repare' and dev_name = 'Unite Central' OR dev_status = 'Repare' and dev_name = 'Unite_Central' 
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
...
<?php
		$device_query = mysql_query("select * from stdevice,location_details,stlocation,device_name	,fonctionnaire		
            				...
            				AND stdevice.fonct_id=fonctionnaire.fonct_id
							 ...
							 AND dev_status = 'Repare' and dev_name='Cable Alimentation' ORDER BY location_details.ld_id DESC")or die(mysql_error());
