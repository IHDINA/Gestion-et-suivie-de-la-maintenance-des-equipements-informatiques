				         ...
				         <div class="col-lg-12">
                          <div class="alert alert-success alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                             <img id="avatar1" class="img-responsive" src="<?php echo $row['respthumbnails']; ?>"><strong> Bienvenue!</strong> <?php echo $client_row['firstname']." ".$client_row['lastname'];  ?>
                          </div>
                        </div>
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        ...
                                        <div>Equipements Endommage</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        ...
                                        <div>Equipements Repares</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        ...
                                        <div>Equipements en Dechet</div><br/>
                                    </div>
                                </div>
							 </div>	
                            </div>
