...
<?php include('session.php'); ?>
    <body id="home">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('Dechet_sidebar.php'); ?>
				...
				<?php	
				 ...
				 where dev_status = 'Dechet' OR dev_status = 'Damage' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Liste Equipement en Dechet (s)</div>
                          <div class="muted pull-right">
								Nombre Equipement: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Liste Equipement en Dechet (s)
 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="print_Dechet.php" class="btn btn-info" id="print" data-placement="left" title="Click"><i class="icon-print icon-large"></i>Imprimer Liste</a>  
...
<?php
		$device_query = mysql_query("select * from stdevice			
							 ...
							 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
							 where dev_status = 'Dechet' ORDER BY location_details.ld_id DESC")or die(mysql_error());
