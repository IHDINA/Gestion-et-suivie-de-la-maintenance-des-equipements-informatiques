  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-check"></i><strong> Imprimer Liste Equipements Endommage</strong>
            </div>
       </div>
    </div>
  </div>
...
"Times New Roman","serif"'> EQUIPEMENTS Endommage:<o:p></o:p></span></p>
...
<?php
    $device_query = mysql_query("select * from stdevice 
         ...
         where dev_status = 'Endommage' OR dev_status = 'endommage' ORDER BY stdevice.id DESC ")or die(mysql_error());
