...
<?php include('session.php'); ?>
    <body id="home">
        ...
        <div class="container-fluid">
			...
			OR dev_status = 'Endommage'    and dev_name = 'scanner'  
	...
	<div class="pull-left">
			...
			<?php	
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Endommage' and dev_name = 'PROJECETUR' 
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
			 ...
			 <?php	
			   ...
			   OR dev_status = 'Endommage' and dev_name = 'cpu' OR dev_status = 'Endommage' 
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
			 ...
			 <?php	
	           ...
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Endommage' and dev_name = 'Ecran' OR dev_status = 'Endommage' and dev_name = 'ecran' 
			   OR dev_status = 'Endommage' and dev_name = 'rc'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
			   ...
			   where 
			   dev_status = 'Endommage'    and dev_name = 'Scanner'                    OR dev_status = 'Endommage'     and dev_name = 'scanner' 
			OR dev_status = 'Endommage'    and dev_name = 'SCANNERr' 
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>
				<li class="">
...
<?php
		...
		$device_query = mysql_query("select * from stdevice,location_details,stlocation,device_name	,fonctionnaire		
			  ...
			  AND 
			   dev_status = 'Endommage'    and dev_name = 'Scanner'  
