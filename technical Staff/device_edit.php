            ...
            <div class="row-fluid">
				<?php include('Device_sidebar.php'); ?>
						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
									 <a href="add_Device.php" class="btn btn-info"  id="add" data-placement="right" title="Cliquer pour ajouter un équipement" ><i class="icon-plus-sign icon-large"></i> Add Device</a>
